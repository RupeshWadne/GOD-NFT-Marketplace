...
const Explore = () => {
    ...
    const fetchNFTs = async() => {
        ...
        const api_key = "BsknAzh7G6qjeH42HF7jgrbxveiZEKhX"
    ...
    return (
        <div>
            ...
            <div className="flex flex-col items-center justify-center py-8 gap-y-3">
                <h1 className="text-center text-xl font-bold">Explore NFTs of ANY Address<br/>Or any contract</h1>
                <div className="flex flex-col w-full justify-center items-center gap-y-2">
                    ...
                    <button className="disabled:bg-slate-500 text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-4 py-2 mt-3 rounded-sm w-1/5" onClick={
                        () => {
